...
public final class Command {
     ...
     * that should be kept local to a widget (like up/down/backspace handling) and doesn't need the extra heavyweight
     * search functionality you get by registering it with a {@link CommandManager}
     *
    ...
    /**
     * Set a callback used for checking if this command should be enabled or not at this moment.
     */
