...
public final class CommandManager {
    ...
    private final Map<String, Command> commandIdsMap = new HashMap<String, Command>();
    private final ArrayList<CommandScope> commandScopes = new ArrayList<CommandScope>();
    ...
    public Opt<Command> findCommand(final String id) {
        ...
        if (commandIdsMap.containsKey(id)) {
            commandOpt.set(commandIdsMap.get(id));
        }
        return commandOpt;
    }
