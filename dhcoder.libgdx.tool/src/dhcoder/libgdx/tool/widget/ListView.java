...
/** This is a non-altered copy of the List class in libgdx scene.ui, except that this name doesn't collide with one of
 * the most used class names in java.util...*/
public class ListView<T> extends Widget implements Cullable {
    ...
    /** The style for a list, see {@link ListView}.
     * @author mzechner
     * @author Nathan Sweet */
